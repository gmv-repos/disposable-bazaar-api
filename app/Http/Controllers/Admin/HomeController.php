...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $totalOrder = Sell::where('sell_type', 2)
            ->whereNot('order_status', OrderStatus::ON_THE_WAY)
        ...
        $lastOrder = Sell_details::orderBy('id', 'DESC')
            ->whereHas('sellInfo', function ($q) {
        ...
        return view('adminPanel.index')->with(
            compact('totalOrder', 'sell', 'customer', 'sellProductList', 'lastOrder', 'productItem'),
        );
    }
}