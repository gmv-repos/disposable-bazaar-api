...
class ProductSubcategoryController extends Controller
{
    public function productSubcategory()
    {
        ...
        return view('adminPanel.product_subcategory.product_subcategory')->with(
            compact('productSubcategory', 'productCategory', 'common_data'),
        );
    }
    ...
    {
        $subcategoryList = ProductSubCategory::where('category_id', $request->category_id)
            ->where('status', 1)
            ->where('deleted', 0)
            ->get();
