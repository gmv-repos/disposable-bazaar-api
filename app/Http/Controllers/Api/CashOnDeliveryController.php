...
class CashOnDeliveryController extends Controller
{
    public function cashOnDeliveryOrder(Request $request)
    {
        ...
        try {
            ...
            $sell->pay_method = 1; /* cashOnDelivery */
            ...
            foreach ($order_items as $item) {
                ...
                if ($unitPrice != $item['price']) {
                    ...
                    $msg = [
                        ...
                        'msg' =>
                        $item['productName'] .
                            ' This product offer period has expired Please add this product to the cart again',
            ...
            $sell = Sell::find($sell->id)
                ->with(['sellDetail', 'orderAddress', 'paymentInfo'])
                ->first();
            $details = [
