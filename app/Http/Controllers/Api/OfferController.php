...
class OfferController extends Controller
{
    public function offerBanner()
    {
        ...
        $offerlist = Offer::where('start_date', '<=', $currentDate)->where('end_date', '>=', $currentDate)->get();
    ...
    public function offerProduct(Request $request)
    {
        ...
        return OfferProductResource::collection(
            Offer_product_list::where('offer_id', $offer_id)
                ->with('productInfo')
