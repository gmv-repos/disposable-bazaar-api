...
@section('main_content')
    ...
    <div class="page-content">
                        ...
                        <div class="btn-group">
                            <div class="d-flex mt-3 gap-3">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    ...
                                    <i class="lni lni-circle-plus"></i> Add Variant
                                </button>
                            </div>
                        </div>
                    </div>
                                ...
                                <td>
                                    <div class="dropdown d-flex justify-content-center">
                                        ...
                                        <ul class="dropdown-menu" style="">
                                            <li onclick="editCategoryData({{ $variant }})">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Create Product Variant</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row mb-2">
                                <label for="inputname" class="col-sm-12 col-form-label pr-0">Name</label>
                                </label>
                                <div class="col-sm-12">
                            ...
                            <div class="row mb-2">
                                <label for="inputname" class="col-sm-12 col-form-label pr-0">Pack Size</label>
                                </label>
                                <div class="col-sm-12">
                                    <input type="number" step="any" name="pack_size" class="form-control">
                                </div>
                            </div>
                        </div>
        ...
        {{-- Edit --}}
        <!-- Edit Modal -->
        <form action="{{ route('admin.product.variants.update') }}" method="post">
            @csrf
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" id="ed_name_name" name="name" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <label for="inputname" class="col-sm-12 col-form-label pr-0">Pack Size
                                    <strong class="text-danger">*</strong>
                                </label>
                                <div class="col-sm-12">
                                    <input type="text" id="ed_name" class="form-control" name="pack_size"
                                        placeholder="Product Variant" required>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex justify-content-end p-3">
...
@section('js')
    <script>
        function editCategoryData(data) {
            $('#ed_name_name').val(data.name);
            $('#ed_name').val(data.pack_size); // Use 'pack_size' instead of 'size'
            $('#category_id').val(data.id); // Assuming 'id' is correct
            $('#category_edit').modal('show'); // Show the modal for editing
        }
