            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    {{-- <div class="d-flex justify-content-end mb-2">
                        <form method="GET" action="{{ route('admin.report.sell') }}" target="_blank">
                        ...
                        {!! \App\Helpers\CommonHelper::displayPrintButtonInBlade('printable-sell-report') !!}
                    </div> --}}
                    <div id="printable-sell-report">
