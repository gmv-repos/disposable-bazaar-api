        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <h1>Sell Report</h1>
                    <form action="{{ route('admin.report.sell.order') }}" method="GET">
                    ...
                    <div class="d-flex justify-content-end mb-2">
                        <form method="GET" action="{{ route('admin.report.sell.order') }}" target="_blank">
                    ...
                    <div id="printable-sell-report">
                        ...
                        <table id="example" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                @php $i = 1; @endphp
                                @foreach ($allSellOrderDetails as $summary)
                                    <tr>
                                        <td>{{ $i++ }}</td>
