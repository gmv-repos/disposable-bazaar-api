        ...
        <div class="card-body p-4">
            <div class="form-body mt-4">
                <form action="{{route('page.update', $page->id)}}" method="post">
                    ...
                    <div class="col-sm-4">
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="page_id" name="page_id" data-placeholder="Select Page" required>                                    
                                    @foreach($pages as $p)
                                        <option value="{{ $p['id'] }}" {{ $p['id'] == $page->page_id ? 'selected' : '' }} >
                                             {{ $p['name'] }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-sm-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="slug"
                                    id="inputSlug"
                                    placeholder="Enter Page Slug" value="{{ $page->slug }}" required>
                        ...
                        <div class="col-sm-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control inputContentClass" name="page_content" id="inputContent" required>
                                    {!! $page->page_content !!}
                                </textarea>
                            </div>
                        </div>
                    ...
                    <div class="mt-4"></div>
                    @include('adminPanel.partials.seo_form_fields._edit', ['seoMetadata' => $page])
