                ...
                <form action="{{ route('expenses.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="expense_type" class="form-label">Expense Account</label>
                            <select
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="expense_type" class="form-label">Bank Account</label>
                            <select
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="expense_type" class="form-label">Cash Account</label>
                            <select
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea
                                ...
                                class="form-control"
                                rows="3"
                                placeholder="Provide a brief description of the expense"></textarea>
                            @error('description')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
