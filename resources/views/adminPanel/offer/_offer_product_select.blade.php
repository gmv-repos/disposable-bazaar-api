                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="card  w-100 itemcard" onclick="selecteditem(this)" style="position: relative">
                            ...
                            <img  style="object-fit: contain" src="http://localhost/ecommerce-laravel/admin/storage/product_images/product_images-16794636707938.png" class="card-img-top cardimageset" alt="...">
