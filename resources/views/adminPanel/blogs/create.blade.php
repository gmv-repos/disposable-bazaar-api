        ...
        <div class="card">
            <div class="card-body p-4">
                <div class="form-body mt-4">
                    <form action="{{route('admin.store.blog')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="border border-3 p-4 rounded">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" name="date"
                                                       id="inputBlogDate"
                                                       placeholder="Enter Blog Date" required value="{{date('Y-m-d')}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="body" id="inputBlogDescription"
                                                  rows="3"></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="inputBlogDescription" class="form-label">Blog Photo</label>
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#inputBlogDescription').summernote({height: 300});
