        ...
        <div class="row">
            <div class="col-sm-12 mt-2" style="padding: 0px;">
                <form action="{{route('admin.pos.storeSalesOrder')}}" method="post" id="paymentshow">
                    @csrf
                    <div class="rightpos">
                        <div class="row d-flex justify-content-between align-items-center posTopbar">
                            <div class="col-sm-4">
                        ...
                        <table class="table w-100">
                            <thead>
                                <tr class="bg-light text-dark py-3">
                                    ...
                                    <th>Product Name</th>
                                    <th>Brand</th>
                                    <th class="d-none">PackSize/Custom</th>
                                    <th>Price</th>
                                    <th>QTY</th>
                                    <th>Total Pieces</th>
                                    <th>Total</th>
...
@section('js')
    <script>
        ...
        function countTotal() {
            ...
            let shippingCost = +$('#customerlist :selected').attr('deliveryCharges') || 0;
            $('#shippingCost').val(shippingCost);
            $('#shippingCostShow').text(shippingCost);
