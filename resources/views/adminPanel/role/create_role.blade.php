                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-2 roldiv">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-check ">
                                        <input class="form-check-input" type="checkbox" value="26"  name="role_id[]" id="flexCheckDefault" checked>
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Customer Ledger
                                        </label>
                                    </div>
                                    <div class="form-check ">
                                        <input class="form-check-input" type="checkbox" value="27"  name="role_id[]" id="flexCheckDefault" checked>
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Supplier Ledger
                                        </label>
                                    </div>
                            ...
                            <div class="row mb-2 roldiv">
                                <div class="col-sm-12 role_head">
                                    <h6><p>Blog Option <input class="form-check-input" type="checkbox" value="h10"  name="role_id[]" id="flexCheckDefault" checked></p></h6>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-check ">
                                        <input class="form-check-input" type="checkbox" value="24"  name="role_id[]" id="flexCheckDefault" checked>
                                        <label class="form-check-label" for="flexCheckDefault">
                                           Add New Blog
                                        </label>
                                    </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-check ">
                                        <input class="form-check-input" type="checkbox" value="25"  name="role_id[]" id="flexCheckDefault" checked>
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Blog List
                                        </label>
                                    </div>
                            ...
                            <div class="row mb-2 roldiv">
                                <div class="col-sm-12 role_head">
                                    <h6><p>Area Option <input class="form-check-input" type="checkbox" value="h11"  name="role_id[]" id="flexCheckDefault" checked></p></h6>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-check ">
                                        <input class="form-check-input" type="checkbox" value="24"  name="role_id[]" id="flexCheckDefault" checked>
