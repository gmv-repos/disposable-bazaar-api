                                            ...
                                            <tr>
                                                <td valign="top" width="100">
                                                    ...
                                                    <p>Payment method: <span
                                                            style="font-size:18px;font-weight:bold">{{ $details['data']->pay_method === 1 ? $details['data']->paymentInfo->card_brand : 'Cash on Delivery' }}</span>
                                                    </p>
                                                </td>
                                            </tr>
                                        </tbody>
                                            ...
                                            <tr>
                                                <td valign="top" style="text-transform:capitalize">
                                                    <p style="font-size:12px;line-height:130%">Please call
                                                        <b> {{ $company_info_share->phone }}</b> in case of any doubts
                                                        or questions.
                                                ...
                                                <td align="center" width="47%">
                                                    <table border="0" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="center">
                                                                    © 2023-Bidec Sol All rights reserved.
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
